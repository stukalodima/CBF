    ...
    public void onBalanceDateFieldValueChange(HasValue.ValueChangeEvent<LocalDate> event) {
        ...
        for(Currency currency: currencyList){
            LoadContext<ForecastBNDetail> forecastBNDetailLoadContext = LoadContext.create(ForecastBNDetail.class)
                    .setQuery(LoadContext.createQuery("select e from untitled_ForecastBNDetail e where e.currency = :currency and e.forecastBN.balanceDate = :balanceDate")
                    .setParameter("currency", currency)
                    .setParameter("balanceDate", forecastDc.getItem().getBalanceDate()))
                    .setView("_local");
...
//        }
        ...
        for(BusinessDirection businessDirection: businessDirectionList){
            LoadContext<ForecastBNDetail> forecastBNDetailLoadContext = LoadContext.create(ForecastBNDetail.class)
                    .setQuery(LoadContext.createQuery("select e from untitled_ForecastBNDetail e where e.forecastBN.businessDirection = :businessDirection and e.forecastBN.balanceDate = :balanceDate")
            ...
            for (ForecastBNDetail detail : forecastBNDetails){
                ...
                balanceCompanyTableDc.getMutableItems().add(forecastCompanyBalance);
